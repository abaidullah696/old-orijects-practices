...
void Bank::choice(){
	...
	cout<<"3. Uppdate information of exxisting acount"<<endl;
	cout<<"4. Check the details of an existing acount"<<endl;
...
void Bank::uppdate(){
		cout<<"Enter id of student those data you want to uppdate ";
		cin>>id;
		for(int i=0;i<total;i++){
		if(id==person[i].ID){
...
void Bank::transaction(){
	...
	int cash;
		...
		cout<<"Address "<<person[i].address<<endl;
		cout<<"Contact "<<person[i].contact<<endl;
		cout<<"\nExxisting Cash "<<person[i].cash<<endl;
		cout<<"Press 1 to deposit "<<endl;
		cout<<"Press 2 to withdraw "<<endl;
		ch=getch();
		switch(ch){
			case '1':
				cout<<"How much cash you want to deposite? ";
				cin>>cash;
